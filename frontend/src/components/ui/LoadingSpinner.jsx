...
const LoadingSpinner = () => {
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-b from-blue-100 via-blue-200 to-blue-400 relative overflow-hidden">
      {/* Optional background motion glows */}
      <motion.div
        className="absolute w-96 h-96 bg-blue-300 rounded-full blur-3xl opacity-30"
        animate={{
          x: [0, 60, -60, 0],
      ...
      {/* 🚗 Advanced animated loader (from your CSS) */}
      <motion.div
        className="loader scale-110 z-10"
      ...
      {/* Text message */}
      <motion.p
        className="text-xl md:text-2xl font-bold text-red-700 mt-10 z-10"
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
      ...
      <motion.p
        className="text-sm md:text-base text-red-600 mt-3 text-center px-6 max-w-md leading-relaxed z-10"
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}

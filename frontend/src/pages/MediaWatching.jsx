...
// import React, { useState, useRef, useEffect } from "react";
// import { useParams, useNavigate } from "react-router-dom";
// import { Clock, Volume2, VolumeX, Maximize, AlertTriangle, Play, Pause } from "lucide-react";
// import { Button } from "@/components/ui/button";
// import { Card, CardContent } from "@/components/ui/card";
// import { Badge } from "@/components/ui/badge";
// import { useToast } from "@/hooks/use-toast";
...
//       .play()
//       .then(() => setIsPlaying(true))
//       .catch((err) => console.warn("Viewer autoplay blocked:", err));
//   };
...
//     const pc = new RTCPeerConnection({ iceServers: ICE_SERVERS_WATCH });
//     pcRef.current = pc;
...
//     pc.onicecandidate = (e) => {
//       if (e.candidate) socket.emit("candidate", { sessionId, targetId: null, candidate: e.candidate });
//     };
...
//       pc.close();
//       setStreamActive(false);
//       sessionStorage.setItem(`ended-${sessionId}`, "true");
//       toast({ title: "Stream Ended", description: "The emergency broadcast has concluded." });
//       navigate("/");
//     });

//     const intv = setInterval(() => setDuration((d) => d + 1), 1000);
...
//   const togglePlay = () => {
//     if (!videoRef.current) return;
//     isPlaying ? videoRef.current.pause() : tryPlay();
//     setIsPlaying((p) => !p);
//   };

//   const toggleFullscreen = () => {
//     if (videoRef.current) document.fullscreenElement ? document.exitFullscreen() : videoRef.current.requestFullscreen();
//   };
...
//                     <div className="absolute bottom-4 right-4 flex gap-2">
//                       <Button onClick={togglePlay} variant="secondary" className="bg-black/50 text-white border-0">
//                         {isPlaying ? <Pause className="h-4 w-4" /> : <Play className="h-4 w-4" />}
//                       </Button>
//                       <Button onClick={toggleMute} variant="secondary" className="bg-black/50 text-white border-0">
//                         {isMuted ? <VolumeX className="h-4 w-4" /> : <Volume2 className="h-4 w-4" />}
//                       </Button>
//                       <Button onClick={toggleFullscreen} variant="secondary" className="bg-black/50 text-white border-0">
//                         <Maximize className="h-4 w-4" />
//                       </Button>
//                     </div>
//                   </div>
...
//               {!isPlaying && (
//                 <div className="my-4">
//                   <Button onClick={tryPlay}>Tap to Start Video</Button>
//                 </div>
//               )}
//               <Card className="mt-4">
//                 <CardContent className="p-4 text-center">
...
//               <h2 className="font-bold text-lg">Stream Ended</h2>
//               <p>The emergency broadcast has concluded.</p>
//             </Card>
//           )}
//         </div>
//       </main>
